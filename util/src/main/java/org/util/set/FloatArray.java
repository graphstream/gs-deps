...
// Creation
	 ...
	 */
	public
	FloatArray( int initial_capacity )
	{
...
// Commands -- on some part of the array	
	...
	public void
	add( float values[], int offset, int length )
	{
		if( cap - pte < length )
		{
			if( pte == 0 )
