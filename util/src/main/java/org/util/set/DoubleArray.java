...
// Creation
	 ...
	 */
	public
	DoubleArray( int initial_capacity )
	{
...
// Commands -- on some part of the array	
	...
	public void
	add( double values[], int offset, int length )
	{
		if( cap - pte < length )
		{
			if( pte == 0 )
...
// Access
	...
	iterator()
	{
		return new Iterator<Double>()
		{
			...
			public Double next() { return beg[pos++]; }
